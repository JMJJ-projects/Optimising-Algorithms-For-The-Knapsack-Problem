...
df = pd.read_csv(csv_file_path, header=None, names=['Taille', 'BT1', 'BT2', 'DP', 'DP_V', 'DP_M', 'DP_G'])
...
plt.plot(df['Taille'], df['DP_V'], label='Programmation Dynamique Value', marker='v')
plt.plot(df['Taille'], df['DP_M'], label='Programmation Dynamique Min Poids', marker='o')
plt.plot(df['Taille'], df['DP_G'], label='Programmation Dynamique Glouton', marker='*')
